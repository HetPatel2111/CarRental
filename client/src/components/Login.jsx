...
const Login = () => {
  ...
  return (
    ...
    text-sm text-gray-600 bg-black/50'>
       <form onSubmit={onSubmithandler} onClick={(e)=>e.stopPropagation()} className="flex flex-col gap-4 m-auto items-start p-6 sm:p-8 py-10 sm:py-12 w-[92%] max-w-80 text-gray-500 rounded-lg shadow-xl border border-gray-200 bg-white">
