...
const Navbar = () => {
  ...
  return (
    ...
    className={`flex items-center justify-between px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 py-4 text-gray-600 border-b border-borderColor relative transition-all 
    ${location.pathname === "/" && "bg-light "}`}>
        <Link to='/'>
            <motion.img whileHover={{scale:1.05}} src={assets.logo} alt="logo" className='h-8' />
        </Link>

        <div className={`max-sm:fixed max-sm:h-[calc(100vh-64px)] max-sm:w-full max-sm:top-16 max-sm:left-0
